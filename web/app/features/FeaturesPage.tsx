...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Get instant SMS or email notifications the moment something unexpected happens — whether your vehicle moves without you, leaves a safe zone overnight, or crosses a boundary you\'ve set. You stay in the loop without having to check the app.',
