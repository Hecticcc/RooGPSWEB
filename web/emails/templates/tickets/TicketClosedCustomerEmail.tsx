...
export default function TicketClosedCustomerEmail(p: TicketEmailPayload) {
  const ticketUrl = `${appBaseUrl}/account/support/${p.ticketId}`;
  return (
    <EmailLayout preview={`Ticket #${p.ticketNumber} closed`}>
      <Text style={heading}>Support ticket closed</Text>
      <Text style={paragraph}>
        Hello{p.recipientName ? ` ${p.recipientName}` : ''}, your support ticket #{p.ticketNumber} has been closed.
      </Text>
      ...
      <Text style={paragraph}>If you have further questions, you can reopen this ticket or create a new one.</Text>
